...
const ch = {
  ...
  PROJECT_DETAILS_TYPE: "项目类型",
  PROJECT_DETAILS_LOCATION: "项目所在地",
  PROJECT_DETAILS_ESTIMATE: "完工时间",
  PROJECT_DETAILS_HOMES: "总户数",
...
const ch_project0 = {
  ...
  STATUS: "现正热售",
  ESTIMATE: "已完工",
  LOCATION: "温哥华｜新西敏市，BC",
  PROJECT_DESCRIPTION:
    "大楼地处新西敏市中心地带的成熟社区，将该区域特有的历史厚重感与现代都市轻快的生活节奏联系起来，为住户提供了一种全新的生活方式。",
  BUBBLE_ONE:
    "项目位于步行适宜、交通发达的社区中心，位置十分便利，距新西敏市区的主干道哥伦比亚街仅一个街区之遥。",
  BUBBLE_TWO:
...
const ch_project1 = {
  ...
  PROJECT_DESCRIPTION:
    "一个充满活力的四层办公中心，于基斯兰奴的商业核心区域提供窗明几净，采光绝佳的展厅与办公场所。",
  BUBBLE_ONE:
    "1650 On Second 提供四层灵活的办公空间，配备两层地下停车场。前两层提供18,260 平方英尺的零售和展示厅，其中一楼面积为8,120 平方英尺，二楼面积为10,140 平方英尺。",
  BUBBLE_TWO:
    "1650 On Second 因其前卫的设计与鲜明的配色，用现代手法改变了西二街一成不变的老旧外观。映射出街道的生动发展的同时，也保留了周边历史文物建筑的独特风韵。大楼正面大片的落地窗柔化了街道环境，并为内部提供了充足的光线，为温哥华葱郁的天际线添上了雅致的一笔。",
  BUBBLE_THREE:
    "两层提供了9,800 平方英尺的明亮办公空间，可欣赏温哥华市区的秀丽景色。独特的室外露台设计与屋顶平台更使得秀美景观一览无余。",
